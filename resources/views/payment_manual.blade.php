                            ...
                            <div class="offset-md-1 py-4">
                                <div class="my-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-icon right">
                                                <input type="hidden" name="amount" value="{{ $doctor_course->course_price - $doctor_course->paid_amount() }}" >
                                                <span style="font-size:15px;font-weight:700;">{{ $doctor_course->course_price - $doctor_course->paid_amount() }}</span>
                                            </div>
                                        </div>
                                    </div>
