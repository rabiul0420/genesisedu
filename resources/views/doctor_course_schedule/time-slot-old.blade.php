        ...
        @if( $detail instanceof \App\ScheduleDetail )
            ...
            <div class="row" style="margin-bottom: 15px">
                ...
                <div style="display: flex; flex-direction: column; margin-bottom: 5px;">
                    <div>
                        ...
                        <div class="text-info">
                            ...
                            {!! highlight_filter_text( $detail->type == 'Class' ? ($detail->video->name ?? '')
                            : ( $detail->type == 'Exam' ? ($detail->exam->name ?? ''):'' ) , $filter_text )  !!}
                    ...
                    <div  style="display: flex; flex-direction: column;margin-bottom: 5px; margin-top: 18px">
                        <div>
                            ...
                            <div class="text-info">
                                ...
                                <button class="class-details" onclick=" alert(`{{ $feedback_or_solve_class->video->description ?? '' }}`) ">
                                    @include('batch_schedule.info-icon')
                                </button>
                            </div>
                        </div>
                ...
                <div class="btn-flex" style="margin-bottom: 15px; padding-left: 5px;padding-right: 5px;">
                    ...
                    <div class="mt-1 px-2 py-1">
                        @include(
                        'batch_schedule.add-question-btn', [
                    ...
                    <div class="dropdown mt-1 px-2 py-1">
                        <button class="btn btn-outline-info dropdown-toggle py-2  btn-sm py-2 box-2 " type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            Rate The Class
                        </button>
                    ...
                    <div class="mt-1 px-2 py-1">
                        <button
                            class="btn btn-sm py-2 box-2 rate-feedback"
                            data-action="submit_rating"
                            {{ $rating_disabled ? 'disabled': '' }}
                            data-detail-id="{{ $detail->id }}"
                            data-course-id="{{$course_id}}"
                            data-slot-id="{{$time_slot->id}}"
                        >
                    ...
                    <div class="mt-1 px-2 py-1" >
                        ...
                        <a href="{{ $class['url']  }}"
                           class="btn btn-sm  px-4 py-2 box-2 {{ !$exam['completed'] ? 'disabled':''  }}">Solve Class
                        </a>
                    </div>
