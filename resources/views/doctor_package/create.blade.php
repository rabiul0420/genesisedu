            ...
            <!-- BEGIN EXAMPLE TABLE PORTLET-->
                <div class="portlet">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        {!! Form::open(['action'=>['DoctorPackageController@store'],'files'=>true,'class'=>'form-horizontal']) !!}

                        <div class="form-body">


                            <div class="panel panel-primary"  style="border-color: #eee; ">
                                <div class="panel-heading" style="background-color:#7fc9f6; color: #FFFFFF; border-color: #ffffff; "><h3>Package Purchase Form</h3></div>
                                <div class="panel-body">
                                    ...
                                    <div class="packages">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Select Package (<i class="fa fa-asterisk ipd-star" style="font-size:9px;"></i>)</label>
                                            <div class="col-md-3">
                                                @php $packages->prepend('Select Package',''); @endphp
                                                {!! Form::select('package', $packages, old('package'),['class'=>'form-control','required'=>'required']) !!}<i></i>
                                            </div>
                                        </div>
                                    </div>
        ...
        $(document).ready(function() {
            ...
            $("body").on( "change", "[name='course_id']", function() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: '/course-changed-in-package-purchase',
                    dataType: 'HTML',
