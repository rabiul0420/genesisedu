        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>'Admin\OnlineExamCommonCodeController@store','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <input type="text" name="exam_comm_code" required value="{{ old('exam_comm_code') }}" class="form-control">
                                </div>
                            </div>
                        </div>
