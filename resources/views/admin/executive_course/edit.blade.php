...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li><a href="{{ url('admin/executive') }}">Executive Course edit</a></li>
            <i class="fa fa-angle-right"></i><li>Executive Course edit</li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Edit Executive Course
                    </div>
                </div>
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\ExecutiveCourseController@update',$executive_course->id],'method'=>'PUT' ,'files'=>true,'class'=>'form-horizontal']) !!}
                        <div class="form-body">
                                ...
                                <div class="col-md-4">
                                    <div class="input-icon right">
                                        <select name="executive_id" class="form-control course" required>
                                                <option value="{{$executive_course->executive->id }}">{{ $executive_course->executive->name }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="input-icon right">
                                        ...
                                        <select name="course_id" class="form-control course" required>
                                            ...
                                            @foreach ($courses as $key=>$course)
                                                <option value="{{ $key }}" {{  $executive_course->course->id ==  $key ? 'selected' : ' ' }} >{{ $course }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
