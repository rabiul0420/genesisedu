        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Faculty Create
                    </div>
                </div>
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\FacultyController@store'],'files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Faculty Name (<i class="fa fa-asterisk ipd-star" style="font-size:9px;"></i>) </label>
                            <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <input type="text" name="faculty_omr_code" required value="{{ old('faculty_omr_code') }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                {!! Form::select('show_in_combined',['No','Yes'], old('show_in_combined'),[ 'class'=>'form-control' ]) !!}<i></i>
                            </div>
                        </div>
