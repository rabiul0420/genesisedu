        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\LectureSheetArticleBatchController@update',$lecture_sheet_article_batch->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        {!! Form::select('year',$years, $lecture_sheet_article_batch->year ? $lecture_sheet_article_batch->year :'' ,['class'=>'form-control','required'=>'required','id'=>'year']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('session_id',$sessions, $lecture_sheet_article_batch->session_id ? $lecture_sheet_article_batch->session_id :'' ,['class'=>'form-control','required'=>'required','id'=>'session_id']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                {!! Form::select('branch_id',$branches, $lecture_sheet_article_batch->branch_id ? $lecture_sheet_article_batch->branch_id : "" ,['class'=>'form-control','required'=>'required']) !!}<i></i>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $lecture_sheet_article_batch->institute_id ? $lecture_sheet_article_batch->institute_id :'' ,['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                        ...
                        <div class="courses">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('course_id',$courses, isset($lecture_sheet_article_batch->course_id) ? $lecture_sheet_article_batch->course_id : '',['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                </div>
                            ...
                            @if($institute_type==1)
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {!! Form::select('faculty_id',$faculties, isset($lecture_sheet_article_batch->faculty_id) ? $lecture_sheet_article_batch->faculty_id : '' ,['class'=>'form-control','id'=>'faculty_id']) !!}<i></i>
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="subjects">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('subject_id',$subjects, isset($lecture_sheet_article_batch->subject_id) ? $lecture_sheet_article_batch->subject_id : '' ,['class'=>'form-control','id'=>'subject_id']) !!}<i></i>
                                </div>
                            </div>
                        </div> -->
                        ...
                        <div class="topics">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('topic_id[]',$topics, isset($lecture_sheet_article_batch->topics) ? $selected_topics : '' ,['class'=>'form-control select2','required'=>'required','id'=>'topic_id','multiple'=>'multiple']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="batches">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('batch_id',$batches, isset($lecture_sheet_article_batch->batch_id) ? $lecture_sheet_article_batch->batch_id : '' ,['class'=>'form-control','required'=>'required','id'=>'batch_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="{{ url('admin/lecture-sheet-article-batch') }}" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                    </div>
                {!! Form::close() !!}
