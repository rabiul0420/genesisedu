        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\LectureSheetTopicAssignController@update',$lecture_sheet_topic_assign->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">

                        <div class="lecture_sheet_topic">
                            <div class="form-group">
                                <label class="col-md-3 control-label">Lecture Sheet Folder(<i class="fa fa-asterisk ipd-star" style="font-size:9px;"></i>) </label>
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        @php  $lecture_sheet_topics->prepend('Select Lecture Sheet Folder', ''); @endphp
                                        {!! Form::select('lecture_sheet_topic_id',$lecture_sheet_topics, $lecture_sheet_topic_assign->lecture_sheet_topic_id ,['class'=>'form-control select2','required'=>'required','id'=>'lecture_sheet_topic_id']) !!}<i></i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $lecture_sheet_topic_assign->institute_id ? $lecture_sheet_topic_assign->institute_id :'' ,['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                        ...
                        <div class="courses">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('course_id',$courses, isset($lecture_sheet_topic_assign->course_id) ? $lecture_sheet_topic_assign->course_id : '',['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                </div>
                        ...
                        <div class="faculties">
                            @if(isset($lecture_sheet_topic_assign->institute->type))
                            @if($lecture_sheet_topic_assign->institute->type==1)
                                <div class="form-group">
                                    <label class="col-md-3 control-label">{{ $lecture_sheet_topic_assign->institute->faculty_label() }}</label>
                                    <div class="col-md-3">
                        ...
                        <div class="disciplines">
                            <div class="form-group">
                                @if(isset($lecture_sheet_topic_assign->institute->type))
                                @if( $lecture_sheet_topic_assign->institute->type!=1 || $lecture_sheet_topic_assign->institute->id == \App\Providers\AppServiceProvider::$COMBINED_INSTITUTE_ID )
                                    <label class="col-md-3 control-label">{{ $lecture_sheet_topic_assign->institute->discipline_label() }}</label>
                                    <div class="col-md-3">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="{{ url('admin/lecture-sheet-topic-assign') }}" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                    </div>
                {!! Form::close() !!}
