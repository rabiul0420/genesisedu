        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\LectureSheetTopicAssignController@store'],'files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('lecture_sheet_topic_id',$lecture_sheet_topics, old('lecture_sheet_topic_id')?old('lecture_sheet_topic_id'):'' ,['class'=>'form-control select2','required'=>'required','id'=>'lecture_sheet_topic_id']) !!}<i></i>
