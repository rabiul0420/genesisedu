    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="lecture_sheet_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/topic-lecture-sheet-update',
                    dataType: 'HTML',
                    data: {lecture_sheet_id : lecture_sheet_id, topic_id : topic_id, topic_content_id:topic_content_id, operation : operation },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/topic-lecture-sheet-edit-list",
                    type: 'GET',
                    data: function (d) {
