        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i> Exams in {{ $topic->name }}
                        ...
                        @endcan
                        @can('Topic Content')
                        <a href="{{url('admin/topic-exam-add/'.$topic->id)}}" class="btn btn-xs btn-success">Add Topic Exam</a>
                        @endcan
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/topic-exam-ajax-list",
                    type: 'GET',
                    data: function (d) {
