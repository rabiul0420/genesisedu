    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="lecture_video_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/topic-lecture-video-update',
                    dataType: 'HTML',
                    data: {lecture_video_id : lecture_video_id, topic_id : topic_id, topic_content_id:topic_content_id, operation : operation },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/topic-lecture-video-edit-list",
                    type: 'GET',
                    data: function (d) {
