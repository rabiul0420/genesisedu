    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="mentor_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/topic-mentor-save',
                    dataType: 'HTML',
                    data: {mentor_id : mentor_id, topic_id : topic_id, operation : operation },
                    success: function( data ) { 
                        ...
                        {
                            $("#label_m_"+data['mentor_id']).removeClass("btn btn-info").addClass("btn btn-danger");
                            $("#label_m_"+data['mentor_id']).html("Delete From Topic");
                        }
                        if(data['status'] == "delete_success")
                        {
                            $("#label_m_"+data['mentor_id']).removeClass("btn btn-danger").addClass("btn btn-info");
                            $("#label_m_"+data['mentor_id']).html("Add to Topic");
                        }
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/topic-mentor-add-list",
                    type: 'GET',
                    data: function (d) {
