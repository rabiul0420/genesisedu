                        ...
                        <div class="panel panel-primary"  style="border-color: #eee; ">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-icon right">
                                            <input type="text" name="bmdc_no" required value="{{ old('bmdc_no')?old('bmdc_no'):'' }}" class="form-control" onkeyup="this.value = this.value.toUpperCase()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            ...
                                            {!! Form::select('medical_college_id',$medical_colleges, old('medical_college_id')?old('medical_college_id'):'' ,['class'=>'form-control']) !!}<i></i>
                                        </div>
                                    </div>
