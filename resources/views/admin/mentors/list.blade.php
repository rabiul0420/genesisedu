        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i>Mentor List
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <div>
                                                {{ $user->name }}
                                                <span
                                                    class="text-danger">{{ $user->id === auth()->id() ? '(You)' : '' }}</span>
                                            </div>
                                        </td>
                                        {{-- <td class="text-left">
                                        ...
                                        <td>
                                            <div style="display: flex; flex-wrap: wrap; gap: 5px;">
                                                @foreach ($user->roles->sortBy('name') as $role)
                                                    <span
                                                        style="padding: 4px 8px; border-radius: 5px; background: #ccc;">{{ $role->name ?? '' }}</span>
                                                @endforeach
                                            </div>
                                        </td>
                                        <td>{{ $user->status == 1 ? 'Active' : 'InActive' }}</td>
                                        <td>
                                            <a href="{{ url('admin/mentors/' . $user->id . '/edit') }}"
