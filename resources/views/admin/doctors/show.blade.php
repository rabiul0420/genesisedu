            ...
            <div class="portlet">
                ...
                <div class="portlet-body">
                    ...
                    <div class="col-md-2" style="border-right: 2px #eeedf2 solid;">
                        <img src="{{asset($doctor->photo)}}" width="120" height="120" style="border-radius: 50%; box-shadow: inset 0 0 2px 4px #ddd;">
                    </div>
                    ...
                    <div class="col-md-10">
                        ...
                        Password : {{ $doctor->main_password }} <br><br>
                        @can('Go To Doctor Profile')
                        <a href="{{ route('go-to-doctor-profile', $doctor->id) }}" class="btn btn-info btn-sm" target="_blank" >Go to Profile</a>
                        @endcan
                    </div>
