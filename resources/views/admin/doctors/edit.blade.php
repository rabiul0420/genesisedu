                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="panel panel-primary"  style="border-color: #eee; ">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            <input type="text" name="bmdc_no" required value="{{ $doctor->bmdc_no }}" maxlength="8" class="form-control">
                                        </div>
                                        {{-- <label class="radio-inline">
                                            <input type="checkbox" name="bmdc_no " value="" {{  $doctor->bmdc_no === "" ? "checked" : '' }} >verified
                                        </label>  --}}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            ...
                                            {!! Form::select('medical_college_id',$medical_colleges, $doctor->medical_college_id?$doctor->medical_college_id:'' ,['class'=>'form-control select2']) !!}<i></i>
                                        </div>
                                    </div>
                        ...
                        <div class="panel panel-primary"  style="border-color: #eee; ">
                            ...
                            <div class="panel-body">
                                <div class="form-group" >
                                    ...
                                    <div class="col-md-5">
                                        <div class="col-md-4">
                                            <input class="form-control" type="file" name="photo" value="{{ $doctor->photo }}">
                                        </div>
                                        <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3" id="id_div_is_verified">
                                <label class="radio-inline">
                                    <input type="radio" name="is_verified" value="yes" {{ $doctor->is_verified === "yes" ? "checked" : '' }}> Yes
                                </label>
                                
                                <label class="radio-inline">
                                    <input type="radio" name="is_verified" value="no" {{ $doctor->is_verified !== "yes" ? "checked" : '' }}> No
                                </label>
                            </div>
                        </div> 
                    </div>
