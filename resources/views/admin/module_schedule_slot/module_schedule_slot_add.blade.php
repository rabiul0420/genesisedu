            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <a href="{{ url('admin/module-schedule-slot-list/'.$module_schedule->id) }}" class="btn btn-xs btn-primary">Module Schedule Slot</a>
                        @endcan
                    </div>
                </div>

                <div class="portlet-body">
                    <input type="hidden" name="module_schedule_id" value="{{ $module_schedule->id }}"/>
                    <div class="row">
                        <div class="form-group col-md-2">
                            <h5>Branch <span class="text-danger"></span></h5>
                            <div class="controls">
                                @php  $branches->prepend('Select Branch', ''); @endphp
                                {!! Form::select('branch_id',$branches, '',['class'=>'form-control select2','required'=>'required','id'=>'branch_id']) !!}<i></i>
                            </div>
                        </div>
                        <div class="location">
                            <div class="form-group col-md-2">
                        ...
                        <div class="floor">
                            <div class="form-group col-md-2">
                                ...
                                <div class="controls">
                                    ...
                                    {!! Form::select('floor',$floors, '',['class'=>'form-control select2','required'=>'required','id'=>'year']) !!}<i></i>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="slot_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/module-schedule-slot-save',
                    dataType: 'HTML',
                    data: {slot_id : slot_id, module_schedule_id : module_schedule_id, operation : operation, _token: '{{ csrf_token() }}' },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-schedule-slot-add-list",
                    type: 'GET',
                    data: function (d) {
