        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body">
                    <input type="hidden" name="module_id" value="{{ $module_schedule_slot->module_schedule->module->id }}"/>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="program_id"]', function() {
                ...
                var module_schedule_slot_id = $('[name="module_schedule_program_id"]').val();           

                $.ajax({
                    type: "POST",
                    url: '/admin/module-schedule-program-save',
                    dataType: 'HTML',
                    data: {program_id : program_id, module_id : module_id, module_schedule_id : module_schedule_id, module_schedule_slot_id : module_schedule_slot_id, operation : operation, _token: '{{ csrf_token() }}' },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-schedule-program-add-list",
                    type: 'GET',
                    data: function (d) {
                        d.module_id = $('[name="module_id"]').val();
                        d.module_schedule_id = $('[name="module_schedule_id"]').val();
                        d.module_schedule_slot_id = $('[name="module_schedule_slot_id"]').val();
