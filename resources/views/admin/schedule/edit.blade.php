        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\ScheduleController@update',$schedule->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-icon right">
                                    <input type="text" name="name" required value="{{ $schedule->name }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-6" id="id_div_schedule_type">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="schedule_type_id" required value="{{ $key }}" {{  ($key == $schedule->schedule_type_id ) ? 'checked' : '' }}  > {{ $value }}
                                </label>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('status', ['1' => 'Active','0' => 'InActive'], $schedule->status,['class'=>'form-control','required'=>'required']) !!}<i></i>
                            </div>
                        </div>                        
