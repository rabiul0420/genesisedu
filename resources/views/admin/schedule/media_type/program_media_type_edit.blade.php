...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Add Media Types in {{ $program->name }}</li>
        </ul>
    </div>
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        @endcan
                        @can('Module Content')
                        <a href="{{url('admin/program-content/'.$program->id)}}" class="btn btn-xs btn-info">Module Contents</a>
                        @endcan
                        @can('Module Content')
                        <a href="{{url('admin/program-media-type-list/'.$program->id)}}" class="btn btn-xs btn-success">Module Media Types</a>
                        @endcan
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="media_type_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/program-media-type-update',
                    dataType: 'HTML',
                    data: {media_type_id : media_type_id, program_id : program_id, program_content_id:program_content_id, operation : operation },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/program-media-type-edit-list",
                    type: 'GET',
                    data: function (d) {
