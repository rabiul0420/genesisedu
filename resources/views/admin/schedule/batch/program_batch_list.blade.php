        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i> Batches in {{ $program->name }}
                        ...
                        @endcan
                        @can('Program Content')
                        <a href="{{url('admin/program-batch-add/'.$program->id)}}" class="btn btn-xs btn-success">Add Program Batch</a>
                        @endcan
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/program-batch-ajax-list",
                    type: 'GET',
                    data: function (d) {
