...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Add Exams in {{ $program->name }}</li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i> Add Exams in {{ $program->name }}
                        ...
                        @endcan
                        @can('Program Content')
                        <a href="{{url('admin/program-exam-list/'.$program->id)}}" class="btn btn-xs btn-success">Program Exams</a>
                        @endcan
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="topic_content_id"]', function() {
                ...
                $.ajax({
                    ...
                    success: function( data ) { 
                        ...
                        {
                            window.location.href = "/admin/program-exam-list/"+data['program_id'];
                        }
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/program-exam-add-list",
                    type: 'GET',
                    data: function (d) {
