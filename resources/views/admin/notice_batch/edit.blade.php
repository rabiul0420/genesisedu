        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\NoticeBatchController@update',$notice_batch->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">

                        <input type="hidden" name="notice_batch_id" value="{{ $notice_batch->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        {!! Form::select('year',$years, $notice_batch->year ? $notice_batch->year :'' ,['class'=>'form-control','required'=>'required','id'=>'year']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('session_id',$sessions, $notice_batch->session_id ? $notice_batch->session_id :'' ,['class'=>'form-control','required'=>'required','id'=>'session_id']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                {!! Form::select('branch_id',$branches, $notice_batch->branch_id ? $notice_batch->branch_id : "" ,['class'=>'form-control','required'=>'required']) !!}<i></i>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $notice_batch->institute_id ? $notice_batch->institute_id :'' ,['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                        ...
                        <div class="courses">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('course_id',$courses, isset($notice_batch->course_id) ? $notice_batch->course_id : '',['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                </div>
                        ...
                        <div class="batches">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('batch_id',$batches, isset($notice_batch->batch_id) ? $notice_batch->batch_id : '' ,['class'=>'form-control','required'=>'required','id'=>'batch_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="notices">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                        ...
                                        {!! Form::select('notice_id[]', $notices,  $selected_notices ,['class'=>'form-control select2','id'=>'notice_id','multiple'=>'multiple']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="{{ url('admin/notice-batch') }}" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                    </div>
                {!! Form::close() !!}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("body").on( "change", "[name='course_id'],[name='branch_id']", function() {
                ...
                var notice_batch_id = $("[name='notice_batch_id']").val();
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    type: "POST",
                    url: '/admin/course-branch-changed-in-notice-batch',
                    dataType: 'HTML',
                    data: {branch_id:branch_id,institute_id:institute_id,course_id: course_id,notice_batch_id:notice_batch_id},
                    success: function( data ) {
