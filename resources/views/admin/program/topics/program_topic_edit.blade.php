    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="topic_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/program-topic-update',
                    dataType: 'HTML',
                    data: {topic_id : topic_id, program_id : program_id, program_content_id:program_content_id, operation : operation },
                    success: function( data ) { 
                        ...
                        {
                            window.location.href = "/admin/program-topic-list/"+data['program_id'];
                        }
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/program-topic-edit-list",
                    type: 'GET',
                    data: function (d) {
