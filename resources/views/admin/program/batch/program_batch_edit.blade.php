...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Add Batches in {{ $program->name }}</li>
        </ul>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="batch_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/program-batch-update',
                    dataType: 'HTML',
                    data: {batch_id : batch_id, program_id : program_id, program_content_id:program_content_id, operation : operation },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/program-batch-edit-list",
                    type: 'GET',
                    data: function (d) {
