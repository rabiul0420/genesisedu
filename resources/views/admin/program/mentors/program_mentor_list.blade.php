        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i> Mentors in {{ $program->name }}
                        ...
                        @endcan
                        @can('Program Content')
                        <a href="{{url('admin/program-mentor-add/'.$program->id)}}" class="btn btn-xs btn-success">Add Program Mentor</a>
                        @endcan
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/program-mentor-ajax-list",
                    type: 'GET',
                    data: function (d) {
