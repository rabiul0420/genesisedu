        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\ProgramController@update',$program->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-icon right">
                                    <input type="text" name="nickname" value="{{ $program->nickname }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-6" id="id_div_program_type">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="program_type_id" required value="{{ $key }}" {{  ($key == $program->program_type_id ) ? 'checked' : '' }}  > {{ $value }}
                                </label>
                                @endforeach
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $program->institute_id, ['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        <div class="input-icon right">
                                            ...
                                            {!! Form::select('course_id',$courses, $program->course_id, ['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('year',$years,$program->year,['class'=>'form-control','required'=>'required','id'=>'year']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('session_id',$sessions,$program->session_id,['class'=>'form-control','required'=>'required','id'=>'session_id']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('status', ['1' => 'Active','0' => 'InActive'], $program->status,['class'=>'form-control','required'=>'required']) !!}<i></i>
                            </div>
                        </div>                        
