        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\ModuleController@store'],'files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-3" id="id_div_module_type">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="module_type_id" required value="{{ $key }}" {{  ($key == old('module_type_id')) ? 'checked' : '' }}  > {{ $value }}
                                </label>
                                @endforeach
                            </div>
                        </div>
