...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Add Program in {{ $module->name }}</li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i> Add Program in {{ $module->name }}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="program_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/module-program-save',
                    dataType: 'HTML',
                    data: {program_id : program_id, module_id : module_id, operation : operation },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-program-add-list",
                    type: 'GET',
                    data: function (d) {
            ...
            $("body").on("click",".btn_view",function(){
                ...
                $('.modal-body').load('/admin/question-view',{program_id: program_id,_token: '{{csrf_token()}}'},function(){
            ...
            $("body").on("click",".btn_log",function(){
                var program_id = $(this).attr('id');
                $('.modal-body').load('/admin/question-edit-log',{program_id : program_id, _token: '{{ csrf_token() }}'},function(){
