...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Media Types in {{ $module->name }}</li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i> Media Types in {{ $module->name }}
                        ...
                        @endcan
                        @can('Module Content')
                        <a href="{{url('admin/module-media-type-add/'.$module->id)}}" class="btn btn-xs btn-success">Add Module Media Type</a>
                        @endcan
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-media-type-ajax-list",
                    type: 'GET',
                    data: function (d) {
