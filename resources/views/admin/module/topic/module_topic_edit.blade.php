...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Add Topices in {{ $module->name }}</li>
        </ul>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="topic_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/module-topic-update',
                    dataType: 'HTML',
                    data: {topic_id : topic_id, module_id : module_id, module_content_id:module_content_id, operation : operation },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-topic-edit-list",
                    type: 'GET',
                    data: function (d) {
