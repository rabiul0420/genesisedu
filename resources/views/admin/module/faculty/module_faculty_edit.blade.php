...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Add Faculties in {{ $module->name }}</li>
        </ul>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="faculty_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/module-faculty-update',
                    dataType: 'HTML',
                    data: {faculty_id : faculty_id, module_id : module_id, module_content_id:module_content_id, operation : operation },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-faculty-edit-list",
                    type: 'GET',
                    data: function (d) {
