        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i> Batches in {{ $module->name }}
                        ...
                        @endcan
                        @can('Module Content')
                        <a href="{{url('admin/module-batch-add/'.$module->id)}}" class="btn btn-xs btn-success"><i class="fa fa-plus"></i> Module Batch</a>
                        @endcan
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-batch-ajax-list",
                    type: 'GET',
                    data: function (d) {
