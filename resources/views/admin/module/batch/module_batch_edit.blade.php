...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Add Batches in {{ $module->name }}</li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i> Add Batches in {{ $module->name }}
                        ...
                        @endcan
                        @can('Module Content')
                        <a href="{{url('admin/module-batch-list/'.$module->id)}}" class="btn btn-xs btn-success">Module Batches</a>
                        @endcan
                        ...
                        <div class="year">
                            <div class="form-group col-md-2">
                                ...
                                <div class="controls">
                                    ...
                                    {!! Form::select('year',$years, $module->year ,['class'=>'form-control select2','required'=>'required','id'=>'year']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="session">
                            <div class="form-group col-md-2">
                                ...
                                <div class="controls">
                                    ...
                                    {!! Form::select('session_id',$sessions, $module->session_id ,['class'=>'form-control select2','required'=>'required','id'=>'session_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="batch_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/module-batch-update',
                    dataType: 'HTML',
                    data: {batch_id : batch_id, module_id : module_id, module_content_id:module_content_id, operation : operation },
                    success: function( data ) { 
                        ...
                        {
                            window.location.href = "/admin/module-batch-list/"+data['module_id'];
                        }
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-batch-edit-list",
                    type: 'GET',
                    data: function (d) {
            ...
            $("body").on( "change", "[name='institute_id']", function() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: '/admin/institute-change-in-module-batch',
                    dataType: 'HTML',
            ...
            $("body").on( "change", "[name='course_id']", function() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: '/admin/course-change-in-module-batch',
                    dataType: 'HTML',
            ...
            $("body").on( "change", "[name='year']", function() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: '/admin/year-change-in-module-batch',
                    dataType: 'HTML',
