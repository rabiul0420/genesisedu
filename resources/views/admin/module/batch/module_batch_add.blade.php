...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Add Batchs in {{ $module->name }}</li>
        </ul>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="batch_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/module-batch-save',
                    dataType: 'HTML',
                    data: {batch_id : batch_id, module_id : module_id, operation : operation },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-batch-add-list",
                    type: 'GET',
                    data: function (d) {
