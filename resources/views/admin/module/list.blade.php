            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        @can('Module')
                        <a href="{{url('admin/module/create')}}"> <i class="fa fa-plus"></i> </a>
                        @endcan
                    </div>
                </div>
                <div>
        ...
        $(document).ready(function() {
            var table = $('.datatable').DataTable({
                ...
                columns: [
                    {data: 'id',name:'id'},
                    {data: 'name',name:'name'},
                    {data: 'module_type.name',name:'module_type.name'},
            ...
            $("body").on( "change", "[name='institute_id']", function() {
                ...
                var view_name = 'module_course_search';
                $.ajax({
                    headers: {
            ...
            $("body").on( "change", "[name='course_id']", function() {
                ...
                var view_name = 'module_year_search';
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            $("body").on( "change", "[name='year']", function() {
                ...
                var view_name = 'module_session_search';
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
