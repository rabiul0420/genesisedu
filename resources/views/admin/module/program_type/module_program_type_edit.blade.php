...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Add Program Types in {{ $module->name }}</li>
        </ul>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="program_type_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/module-program-type-update',
                    dataType: 'HTML',
                    data: {program_type_id : program_type_id, module_id : module_id, module_content_id:module_content_id, operation : operation },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-program-type-edit-list",
                    type: 'GET',
                    data: function (d) {
