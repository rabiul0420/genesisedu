        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\ModuleController@update',$module->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <input type="text" name="name" required value="{{ $module->name }}" class="form-control">
                                </div>
                            </div>
                        </div>

                        <div class="form-group ">
                            <label class="col-md-3 control-label">Module Type (<i class="fa fa-asterisk ipd-star" style="font-size:9px;"></i>) </label>
                            <div class="col-md-3" id="id_div_module_type">
                                @foreach($module_types as $key=>$value)
                                <label class="radio-inline">
                                    <input type="radio" name="module_type_id" required value="{{ $key }}" {{  ($key == $module->module_type_id) ? 'checked' : '' }}  > {{ $value }}
                                </label>
                                @endforeach
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $module->institute_id, ['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        <div class="input-icon right">
                                            ...
                                            {!! Form::select('course_id',$courses, $module->course_id, ['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('year',$years,$module->year,['class'=>'form-control','required'=>'required','id'=>'year']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('session_id',$sessions,$module->session_id,['class'=>'form-control','required'=>'required','id'=>'session_id']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                {!! Form::select('status', ['1' => 'Active','0' => 'InActive'], $module->status,['class'=>'form-control','required'=>'required']) !!}<i></i>
                            </div>
                        </div>                        
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="{{ url('admin/module') }}" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
