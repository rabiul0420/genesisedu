...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li> Add Disciplines in {{ $module->name }}</li>
        </ul>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="discipline_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/module-discipline-update',
                    dataType: 'HTML',
                    data: {discipline_id : discipline_id, module_id : module_id, module_content_id:module_content_id, operation : operation },
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/module-discipline-edit-list",
                    type: 'GET',
                    data: function (d) {
