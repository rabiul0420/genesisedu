        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\ExamBatchController@update',$exam_batch->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">

                        <input type="hidden" name="exam_batch_id" value="{{ $exam_batch->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        {!! Form::select('year',$years, $exam_batch->year ? $exam_batch->year :'' ,['class'=>'form-control','required'=>'required','id'=>'year']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('session_id',$sessions, $exam_batch->session_id ? $exam_batch->session_id :'' ,['class'=>'form-control','required'=>'required','id'=>'session_id']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                {!! Form::select('branch_id',$branches, $exam_batch->branch_id ? $exam_batch->branch_id : "" ,['class'=>'form-control','required'=>'required']) !!}<i></i>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $exam_batch->institute_id ? $exam_batch->institute_id :'' ,['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                        ...
                        <div class="courses">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('course_id',$courses, isset($exam_batch->course_id) ? $exam_batch->course_id : '',['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                </div>
                        ...
                        <div class="batches">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('batch_id',$batches, isset($exam_batch->batch_id) ? $exam_batch->batch_id : '' ,['class'=>'form-control','required'=>'required','id'=>'batch_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="exams">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                        @php  $exams->prepend('Select Online Exam', ''); @endphp
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="{{ url('admin/exam-batch') }}" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                    </div>
                {!! Form::close() !!}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("body").on( "change", "[name='course_id'],[name='branch_id']", function() {
                ...
                var exam_batch_id = $("[name='exam_batch_id']").val();
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    type: "POST",
                    url: '/admin/course-branch-changed-in-exam-batch',
                    dataType: 'HTML',
                    data: {branch_id:branch_id,institute_id:institute_id,course_id: course_id,exam_batch_id:exam_batch_id},
                    success: function( data ) {
