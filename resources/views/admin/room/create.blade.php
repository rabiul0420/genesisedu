        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\RoomController@store'],'files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('branch_id',$branches, old('branch_id'), ['class'=>'form-control','required'=>'required','id'=>'branch_id']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Live Link</label>
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <textarea name="live_link" class="form-control">{{ old('live_link') }}</textarea>
                                </div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-3 control-label">Live Link Username </label>
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <input type="text" name="live_link_username" value="{{ old('live_link_username') }}" class="form-control">
                                </div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-3 control-label">Live Link Password </label>
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <input type="text" name="live_link_password" value="{{ old('live_link_password') }}" class="form-control">
                                </div>
                            </div>
                        </div>
