                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <textarea name="live_link" class="form-control">{{ $room->live_link }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <input type="text" name="live_link_username" value="{{ $room->live_link_username }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <input type="text" name="live_link_password" value="{{ $room->live_link_password }}" class="form-control">
                                </div>
                            </div>
                        </div>
