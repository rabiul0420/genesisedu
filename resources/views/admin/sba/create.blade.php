...
A" name="question_title" required rows="9" class="form-control">{{ old('question_title') }}</textarea>
                                </div>
                            </div>
                        </div>
            ...
            $(document).ready(function() {
                ...
                $('#add').click(function() {
                    ...
                    $('#dynamic_field').append('<div id="row' + i + '"> ' +
                        ...
                        '][link]" value="{{ old('video_link') }}" class="form-control name_list" placeholder="Video" required/>' +
                        '<input type="text" name="videos[' + i +
                        '][password]" value="" class="form-control name_list" placeholder="Password" style="margin-top:15px" required/>' +
                        '<button type="button" name="remove" id="' + i +
                        '" class="btn btn-danger btn_remove" style="width:10px; margin-top:15px;display:flex; justify-content: center;" >X</button></div></div>'
                    );
                });
