...
FTTFF" name="question_title" required rows="9"
                                        class="form-control">{{ $question->question_and_answers }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-icon right">
                                    <textarea id="discussion" name="discussion" class="form-control">{{ $question->discussion }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-icon right">
                                    <input type="text" name="password"  value="{{$question->password}}" class="form-control">
                                </div>
                            </div>
                        </div> --}}
            ...
            $(document).ready(function() {
                ...
                $('#add').click(function() {
                    ...
                    $('#dynamic_field').append('<div id="row' + i + '"> ' +
                        ...
                        '][link]" value="{{ old('video_link') }}" class="form-control name_list" placeholder="Video" />' +
                        '<input type="text" name="videos[' + i +
                        '][password]" value="" class="form-control name_list" placeholder="Password" />' +
