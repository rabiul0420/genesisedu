...
{!! Form::open(['url'=>['admin/complain-replied'],'method'=>'post','files'=>true,'class'=>'form-horizontal']) !!}
                        <div class="form-body">

                            <div class="form-group">
                                <div class="col-md-1"><b>Complain</b></div>
                                <div class="col-md-11">                                    
                                    
                                    <input type="hidden" name="complain_id" required value="{{$complain_id->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-11">                                    
                                    <?php
                                        $temp_name = \App\DoctorComplainReply::select('*')->where('complain_id', $complain_id->id)->get();
