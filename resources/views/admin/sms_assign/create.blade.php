        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\SmsAssignController@store'],'files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('sms_id',$smss, old('sms_id')?old('sms_id'):'' ,['class'=>'form-control select2','required'=>'required','id'=>'sms_id']) !!}<i></i>
