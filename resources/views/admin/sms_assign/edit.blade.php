        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\SmsAssignController@update',$sms_assign->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('sms_id',$smss, $sms_assign->sms_id ,['class'=>'form-control select2','required'=>'required','id'=>'sms_id']) !!}<i></i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $sms_assign->institute_id ? $sms_assign->institute_id :'' ,['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                        ...
                        <div class="courses">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('course_id',$courses, isset($sms_assign->course_id) ? $sms_assign->course_id : '',['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                </div>
                        ...
                        <div class="faculties">
                            @if(isset($sms_assign->institute->type))
                            @if($sms_assign->institute->type==1)
                                <div class="form-group">
                        ...
                        <div class="disciplines">
                            <div class="form-group">
                                @if(isset($sms_assign->institute->type))
                                @if($sms_assign->institute->id == 16 || $sms_assign->institute->type!=1)
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="{{ url('admin/sms-assign') }}" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                    </div>
                {!! Form::close() !!}
