        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\LectureVideoBatchController@store'],'files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
        ...
        $(document).ready(function() {
            ...
            $('.select2').select2({
                templateSelection: function (data, container) {
                    $('.select2-container--default .select2-selection--multiple .select2-selection__choice').css('background-color','colorGreen');
                },
