                                            ...
                                            @for($c = 0 ;$c<=($count_slots);$c++)
                                                @if($c=='0')
                                                    <td  style="border-left-width: 1px;border-bottom-width: 1px;">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div style="text-align:right;" data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="{{ $schedule_date }}" class="">
                                                                ...
                                                                --}}
                                                                <input type="text"  name="schedule_dateggg" id="{{'schedule_date_main'.'__1'.'_'.$d.'_'.$c }}" onchange="change_df_value(this.id,this.value,{{ $count_slots+1 }})" value="{{ $schedule_date }}" size="16" class="form-control input-append date">
                                                            ...
                                                            <div id="{{ 'date_day__1' . '_' . $d . '_' . $c }}" style="text-align:center;">
                                                                ...
                                                                {{ date('l',date_create_from_format('Y-m-d',$schedule_date)->getTimestamp()) }}
                                                ...
                                                @elseif($m_slot_lists[$c] !=3 )
                                                    <td  style="border-left-width: 1px;border-bottom-width: 1px;">
                                                        ...
                                                        {!! Form::hidden('schedule_date['.$d.']['.$c.'][]', $schedule_date, $data) !!}
                                                        ...
                                                        <div class="">
                                                            ...
                                                            {!! Form::select('topic_id['.$d.']['.$c.'][]', $topics_list,''/*collect(explode(',',$schedules[$j]->topic_id))*/,$data) !!}
                                                        ...
                                                        <div class="">
                                                            ...
                                                            @endphp
                                                            {!! Form::select('teacher_id['.$d.']['.$c.'][]', $teachers_list,''/*collect( $schedules[$j]->teacher_id)*/,$data) !!}
                                                        </div>
                                                    </td>
                                                    @php $j++; @endphp
                                                @endif
                                ...
                                <tr>
                                    <td colspan="{{ count($batch_slots) + 1}}">
                                        <div style="text-align:right;">
                                            <span id="add" style="cursor: pointer;" title="add row">
