                                                    ...
                                                    <td  style="border-left-width: 1px;border-bottom-width: 1px;">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div style="text-align:right;" data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="{{ date("Y-m-d", strtotime($schedule_details->initial_date)) }}" class="">
                                                                ...
                                                                --}}
                                                                <input type="text"  name="schedule_dateggg" id="{{'schedule_date_main'.'__1'.'_'.$d.'_'.$class_count_C }}" onchange="change_df_value(this.id,this.value,{{ $count_slots+1 }})" value="{{ $schedule_dates[$d] }}" size="16" class="form-control input-append date">

                                                            </div>
                                                            <br>
                                                            <div id="{{ 'date_day__1' . '_' . $d . '_' . $class_count_C }}" style="text-align:center;">
                                                ...
                                                @elseif($m_slot_lists[$class_count_C-1]==1 || $m_slot_lists[$class_count_C-1]==2)
                                                    <td  style="border-left-width: 1px;border-bottom-width: 1px;">
                                                        @php $data = array('type'  => 'hidden',
                                                                        'id'    => 'schedule_date'.'__1'.'_'.$d.'_'.$class_count_C,
                                                                        'class' => ''
                                                                        );
                                                        @endphp
                                                        ...
                                                        <div class="">
                                                            ...
                                                            @if(($m_slot_lists[$class_count_C-1]==2))
                                                                ...
                                                                {!! Form::select('examtopic['.$d.'][]', $topics_list,(isset($key) ? $key : '') ,$data) !!}
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function remove_item(element_id){ alert(element_id);
        ...
        $(document).ready(function() {
            ...
            $("body").on( "click", "[id='add']", function() {
                //alert($(".table tr:last").prev().find("span").html());exit;
                var d = $(this).val();
                var r = $(this).val();
                var schedule_details_id = $("#schedule_details_id").html();
                //alert(schedule_details_id);exit;
                $.ajax({
                    headers: {
                    ...
                    dataType: 'HTML',
                    data: { d:d+1,r:r+1,schedule_details_id:schedule_details_id },
