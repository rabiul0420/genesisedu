                    ...
                    <div class="form-body">
                        ...
                        <div class="panel panel-primary"  style="border-color: #eee; ">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            <input type="text" name="name" placeholder="e.g: Specila Schedule - March'20" value="{{ $schedule_details->name?$schedule_details->name:'' }}" class="form-control" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            <input type="text" name="tag_line" placeholder="e.g: Every Monday & Thursday" value="{{ $schedule_details->tag_line?$schedule_details->tag_line:'' }}" class="form-control" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            <input type="text" name="address" placeholder="Schedule Address" value="{{ $schedule_details->address?$schedule_details->address:'' }}" class="form-control" >
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            <input type="text" name="contact_details" placeholder="Schedule Contact Person and Mobile No" value="{{ $schedule_details->contact_details?$schedule_details->contact_details:'' }}" class="form-control" >
                                        </div>
                                    </div>
                        ...
                        <div class="panel panel-primary"  style="border-color: #eee; ">
                            ...
                            <div class="panel-body">
                                ...
                                @include( 'admin.batches_schedules.batches' )
...
{{--                                        <div class="col-md-3">--}}
{{--                                            <div class="input-icon right">--}}
{{--                                                {!! Form::select('batch_id[]',$batches, $schedule_details->batch_id?$schedule_details->batch_id : '' ,--}}
...
{{--                                </div>--}}
                                ...
                                <div class="faculties">
                                    @if(isset($schedule_details->institute->type))
                                    @if($schedule_details->institute->type==1)
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">{{ $schedule_details->institute->faculty_label() }}</label>
                                            <div class="col-md-3">
                                                @php  $faculties->prepend('Select Faculty', ''); @endphp
                                                {!! Form::select('faculty_id[]',$faculties, $selected_faculties,['class'=>'form-control  select2 ', 'multiple' => 'multiple','id'=>'faculty_id']) !!}<i></i>
                                            </div>
                                ...
                                <div class="subjects">
                                    <div class="form-group">
                                        @if(isset($schedule_details->institute->type))
                                        @if($schedule_details->institute->type!=1 || $schedule_details->institute->id == \App\Providers\AppServiceProvider::$COMBINED_INSTITUTE_ID )
                                        <label class="col-md-3 control-label">{{ $schedule_details->institute->discipline_label() }}</label>
                                        <div class="col-md-3">
                        ...
                        <div class="panel panel-primary"  style="border-color: #eee; ">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" name="initial_date" id="initial_date" autocomplete="off" placeholder="2020-01-02" onchange="change_wd_value(this.value)" value="{{ $schedule_details->initial_date?date('Y-m-d',strtotime($schedule_details->initial_date)):'' }}" required class="form-control input-append date">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            @php  $slots_list->prepend('Select Slot', ''); @endphp
                                            {!! Form::select('slot_type[]',$slots_list, !empty($batch_slots[4])?$batch_slots[4]->slot_type:'' ,['class'=>'form-control']) !!}<i></i>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <input type="text" class="form-control timepicker" name="start_time[]" value="{{ !empty($batch_slots[4])?$batch_slots[4]->start_time:'' }}">
                                            {{--<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>--}}
                                            <span class="input-group-addon">To</span>
                                            <input type="text" class="form-control timepicker" name="end_time[]" value="{{ !empty($batch_slots[4])?$batch_slots[4]->end_time:'' }}">
                                            {{--<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>--}}
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            @php  $slots_list->prepend('Select Slot', ''); @endphp
                                            {!! Form::select('slot_type[]',$slots_list, !empty($batch_slots[5])?$batch_slots[5]->slot_type:'' ,['class'=>'form-control']) !!}<i></i>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <input type="text" class="form-control timepicker" name="start_time[]" value="{{ !empty($batch_slots[5])?$batch_slots[5]->start_time:'' }}">
                                            {{--<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>--}}
                                            <span class="input-group-addon">To</span>
                                            <input type="text" class="form-control timepicker" name="end_time[]" value="{{ !empty($batch_slots[5])?$batch_slots[5]->end_time:'' }}">
                                            {{--<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>--}}
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                {!! Form::select('status', ['1' => 'Active','0' => 'InActive'], old('status', $schedule_details->status),['class'=>'form-control']) !!}<i></i>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-bordered table-striped routine-rooms table_routine" id="id_table">
                                <tr align="center" bgcolor="#d2d2d2">
                                    <th>Date of Schedule lectures/exams/others</th>
                                ...
                                @if(!empty($topics_list))
                                    ...
                                    @foreach($schedule_rows as $key=>$schedules)
                                        @php $j=0; @endphp
                                        <tr id="{{ 'row_'.$d }}">
                                            @for($c = 0 ;$c<=($count_slots);$c++)
                                                @if($c=='0')
                                                    <td  style="border-left-width: 1px;border-bottom-width: 1px;">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div style="text-align:right;" data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="{{ $key }}" class="">
                                                                ...
                                                                --}}
                                                                <input type="text"  name="schedule_dateggg" id="{{'schedule_date_main'.'__1'.'_'.$d.'_'.$c }}" onchange="change_df_value(this.id,this.value,{{ $count_slots+1 }})" value="{{ $key }}" size="16" class="form-control input-append date">
                                                ...
                                                @elseif($m_slot_lists[$c] !=3)
                                                    <td  style="border-left-width: 1px;border-bottom-width: 1px;">
                                                        ...
                                                        {!! Form::hidden('schedule_date['.$d.']['.$c.'][]', $key, $data) !!}
                                                        ...
                                                        <div class="">
                                                            ...
                                                            {!! Form::select('topic_id['.$d.']['.$c.'][]', $topics_list,isset($schedules[$j]->topic_id)?collect(explode(',',$schedules[$j]->topic_id)):'',$data) !!}

                                                        </div>
                                                        <br>
                                                        <div class="">
                                                            @php  $teachers_list->prepend('Select Teacher', '') @endphp
                                                            @php
                                                                $data = array('class' => 'form-control m-bot15');
                                                            @endphp
                                                            {!! Form::select('teacher_id['.$d.']['.$c.'][]', $teachers_list,isset($schedules[$j]->topic_id)?collect( $schedules[$j]->teacher_id):'',$data) !!}
                                                        </div>
                                                    </td>
                                                    @php $j++; @endphp
                                                @endif
                                ...
                                @endif
                                <tr>
                                    <td colspan="{{ count($batch_slots) + 1}}">
