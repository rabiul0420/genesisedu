        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\LectureVideoAssignController@update',$lecture_video_assign->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('lecture_video_id',$lecture_videos, $lecture_video_assign->lecture_video_id ,['class'=>'form-control select2','required'=>'required','id'=>'lecture_video_id']) !!}<i></i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $lecture_video_assign->institute_id ? $lecture_video_assign->institute_id :'' ,['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                        ...
                        <div class="courses">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('course_id',$courses, isset($lecture_video_assign->course_id) ? $lecture_video_assign->course_id : '',['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                </div>
                        ...
                        <div class="faculties">
                            @if(isset($lecture_video_assign->institute->type))
                            @if($lecture_video_assign->institute->type==1)
                                <div class="form-group">
                                    <label class="col-md-3 control-label">{{ $lecture_video_assign->institute->faculty_label() }}</label>
                                    <div class="col-md-3">
                        ...
                        <div class="disciplines">
                            <div class="form-group">
                                @if(isset($lecture_video_assign->institute->type))
                                @if( $lecture_video_assign->institute->type != 1 || $lecture_video_assign->institute->id == \App\Providers\AppServiceProvider::$COMBINED_INSTITUTE_ID )
                                        <label class="col-md-3 control-label">{{ $lecture_video_assign->institute->discipline_label() }}</label>
                                    <div class="col-md-3">
