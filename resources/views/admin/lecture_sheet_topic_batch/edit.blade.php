        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\LectureSheetTopicBatchController@update',$lecture_sheet_topic_batch->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        {!! Form::select('year',$years, $lecture_sheet_topic_batch->year ? $lecture_sheet_topic_batch->year :'' ,['class'=>'form-control','required'=>'required','id'=>'year']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('session_id',$sessions, $lecture_sheet_topic_batch->session_id ? $lecture_sheet_topic_batch->session_id :'' ,['class'=>'form-control','required'=>'required','id'=>'session_id']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                {!! Form::select('branch_id',$branches, $lecture_sheet_topic_batch->branch_id ? $lecture_sheet_topic_batch->branch_id : "" ,['class'=>'form-control','required'=>'required']) !!}<i></i>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $lecture_sheet_topic_batch->institute_id ? $lecture_sheet_topic_batch->institute_id :'' ,['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                        ...
                        <div class="courses">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('course_id',$courses, isset($lecture_sheet_topic_batch->course_id) ? $lecture_sheet_topic_batch->course_id : '',['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                </div>
                                <input type="hidden" name="url" value="{{$url}}">
                            </div>
                        </div>

                        <div class="lecture_sheet_topics">
                            <div class="form-group">
                                <label class="col-md-3 control-label">Lecture Sheet Topics (<i class="fa fa-asterisk ipd-star" style="font-size:9px;"></i>) </label>
                                <div class="col-md-3">
                                    @php  $lecture_sheet_topics->prepend('Select Lecture Sheet Topic', ''); @endphp
                                    {!! Form::select('lecture_sheet_topic_id[]',$lecture_sheet_topics, isset($selected_sheets) ? $selected_sheets : '' ,['class'=>'form-control select2','required'=>'required','id'=>'lecture_sheet_topic_id','multiple'=>'multiple']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="batches">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('batch_id',$batches, isset($lecture_sheet_topic_batch->batch_id) ? $lecture_sheet_topic_batch->batch_id : '' ,['class'=>'form-control','required'=>'required','id'=>'batch_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="{{ url('admin/lecture-sheet-topic-batch') }}" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                    </div>
                {!! Form::close() !!}
        ...
        $(document).ready(function() {
            ...
            $("body").on( "change", "[name='course_id'],[name='branch_id']", function() {
                ...
                $.ajax({
                    ...
                    url: '/admin/ajax-lecture-sheet-topics',
                    dataType: 'HTML',
                    ...
                    success: function( data ) {
                        ...
                        $('.lecture_sheet_topics').html(data['lecture_sheet_topics']);
