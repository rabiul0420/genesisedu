        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\NoticeAssignController@store'],'files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('notice_id',$notices, old('notice_id')?old('notice_id'):'' ,['class'=>'form-control select2','required'=>'required','id'=>'notice_id']) !!}<i></i>
