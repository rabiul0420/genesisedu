                        ...
                        <div class="panel panel-primary"  style="border-color: #eee; ">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <label class="col-md-1 control-label">Gender (<i class="fa fa-asterisk ipd-star" style="font-size:11px;"></i>) </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-icon right">
                                            <input type="text" name="bmdc_no" required value="{{ old('bmdc_no')?old('bmdc_no'):'' }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            <input type="text" name="mobile_number" required value="{{ old('mobile_number')?old('mobile_number'):'' }}" maxlength="11" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-1 control-label">Medical College (<i class="fa fa-asterisk ipd-star" style="font-size:11px;"></i>) </label>
                                    <div class="col-md-3">
                                        <div class="input-icon right">
                                            @php  $medical_colleges->prepend('Select Medical College', ''); @endphp
                                            {!! Form::select('medical_college_id',$medical_colleges, old('medical_college_id')?old('medical_college_id'):'' ,['class'=>'form-control','required'=>'required']) !!}<i></i>
                                        </div>
                                    </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                            ...
                                            {!! Form::select('permanent_division_id',$divisions, old('permanent_division_id')?old('permanent_division_id'):'' ,['class'=>'form-control']) !!}<i></i>
                                    </div>
                        ...
                        <div class="panel panel-primary"  style="border-color: #eee; ">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                            @php  $divisions->prepend('Select Division', ''); @endphp
                                            {!! Form::select('present_division_id',$divisions, old('present_division_id')?old('present_division_id'):'' ,['class'=>'form-control']) !!}<i></i>
                                    </div>
