        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                        {!! Form::open(['action'=>['Admin\ReferenceCourseController@update',$reference_courses->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label">Course Name</label>
                                <div class="col-md-4">
                                    <div class="input-icon right">
                                        <input type="text" name="course_name" required value="{{ $reference_courses->name }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-icon right">
                                        <input type="text" name="reference_code" required value="{{ $reference_courses->reference_code }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
