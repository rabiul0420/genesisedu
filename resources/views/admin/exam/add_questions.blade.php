            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <input type="hidden" name="question_type_id" value="{{ $ques_type->id }}"/>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '[name="question_id"]', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/add-exam-question',
                    dataType: 'HTML',
                    data: {question_id : question_id, exam_id : exam_id, question_type : question_type, operation : operation },
                    success: function( data ) { 
                        ...
                        {
                            $("#label_m_"+data['question_id']).removeClass("btn btn-info").addClass("btn btn-danger");
                            $("#label_m_"+data['question_id']).html("Delete From Exam");
                        }
                        if(data['success_status'] == "delete_success")
                        {
                            $("#label_m_"+data['question_id']).removeClass("btn btn-danger").addClass("btn btn-info");
                            $("#label_m_"+data['question_id']).html("Add to Exam");
                        }
                        ...
                        if(data['question_add_status'] == "question_exist")
                        {
                            window.location.href = "/admin/exam-questions/"+data['exam_id'];
                        }
                    }
            ...
            var table = $('.datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'question', name: 'd1.question_and_answers', "width": "50%"},
                    {data: 'references'},
