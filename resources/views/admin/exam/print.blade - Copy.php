...
<div style="width:1000px; overflow:auto; border:0px #000000 solid; margin:0 auto; margin-top:0px; ">
    ...
    ?>
        <?php   foreach ($vlaue as $new_key=>$new_vlaue) {   ?>
            <div style="width:500px; border:0px #000000 solid; text-align:left; padding-right:10px; height:auto; overflow:auto; margin-bottom: 20px; float: left;">
                ...
                <span style="font-family:Verdana; font-size:13px; font-weight:normal;">
                    ...
                    @php
                        ...
                        foreach ($question as $individual_question){
                            $temp_name = \App\Question::select('question_title')->where('id',$individual_question)->get()->toArray();
                            ...
                            foreach ($temp_name as $value){
                                $answer[] = $value['answer'];
                                echo "<br>".strtolower($value['sl_no'])."). ".strip_tags($value['answer']);
                            }
                        }
                    @endphp
