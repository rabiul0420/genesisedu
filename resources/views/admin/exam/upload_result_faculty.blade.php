        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'admin/result-submit-faculty','files'=>true,'class'=>'form-horizontal']) !!}

                    <div class="col-md-6" style="margin-top: 20px;">
                        <input type="hidden" name="exam_id" value="{{ Request::segment(3) }}">

                        <div class="form-group" >
                            <label class="col-md-4 control-label">Select Front Part</label>
                            <div class="col-md-8">
                                <div class="input-icon right">
                                    <input class="form-control" required type="file" name="result_front_part">
                                </div>
                            </div>
                        </div>

                        <div class="form-group" >
                            <label class="col-md-4 control-label">Select Back Part</label>
                            <div class="col-md-8">
                                <div class="input-icon right">
                        ...
                        <div class="form-group" >
                            <label class="col-md-4 control-label">Select Last Part</label>
                            <div class="col-md-8">
                                <div class="input-icon right">
                    ...
                    <div class="col-md-6" style="margin-top: 20px;">
                        ...
                        <div class="form-group" >
                            <label class="col-md-4 control-label">Select Currect Answer</label>
                            <div class="col-md-8">
                                <div class="input-icon right">
                                    <input class="form-control" type="file" name="answer" required>
                                </div>
                            </div>
                        </div>
