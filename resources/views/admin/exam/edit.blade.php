        ...
        <div class="col-md-12">
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>{{ $title }}<br>
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-icon right">
                                    <a href="{{ url('admin/exam-questions/'.$exam->id) }}" class="btn btn-xs btn-info" target="_blank">Exam questions</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-11">
                                <div class="input-icon right">
                                    <input type="text" name="nickname" value="{{ $exam->nickname }}" class="form-control">
                                </div>
                            </div>
                        </div>
