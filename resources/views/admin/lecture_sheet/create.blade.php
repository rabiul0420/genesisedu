                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <input type="text" name="pdf_file" value="{{ old('pdf_file') }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    ...
                                    {!! Form::select('lecture_sheet_topic_id[]',$lecture_sheet_topics, '' ,['class'=>'form-control  select2','multiple'=>'multiple','required'=>'required','id'=>'lecture_sheet_topic_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
