        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\DiscountRequestNumberController@update',$discount_request_number->id],'method'=>'PUT', 'class'=>'form-horizontal']) !!}
                        {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <input type="text" name="name"  value="{{ $discount_request_number->name }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <input type="text" name="mobile_number"  value="{{ $discount_request_number->mobile_number }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                {!! Form::select('status', ['1' => 'Active','0' => 'InActive'] ,['class'=>'form-control','required'=>'required']) !!}<i></i>
                            </div>
                        </div>
