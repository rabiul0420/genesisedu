        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\OnlineExamLinkController@update',$online_exam_link->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    @php  $exam_comm_codes->prepend('Select Exam Common Code', ''); @endphp
                                    {!! Form::select('exam_comm_code_id',$exam_comm_codes, $online_exam_link->exam_comm_code_id ? $online_exam_link->exam_comm_code_id :'' ,['class'=>'form-control','required'=>'required']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="years">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        {!! Form::select('year',$years, $online_exam_link->year ? $online_exam_link->year :'' ,['class'=>'form-control','required'=>'required','id'=>'year']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('session_id',$sessions, $online_exam_link->session_id ? $online_exam_link->session_id :'' ,['class'=>'form-control','required'=>'required','id'=>'session_id']) !!}<i></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $online_exam_link->institute_id ? $online_exam_link->institute_id :'' ,['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                        ...
                        <div class="courses">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('course_id',$courses, isset($online_exam_link->course_id) ? $online_exam_link->course_id : '',['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                </div>
                            ...
                            @if($institute_type==1)
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {!! Form::select('faculty_id',$faculties, isset($online_exam_link->faculty_id) ? $online_exam_link->faculty_id : '' ,['class'=>'form-control','id'=>'faculty_id']) !!}<i></i>
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="subjects">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('subject_id',$subjects, isset($online_exam_link->subject_id) ? $online_exam_link->subject_id : '' ,['class'=>'form-control','id'=>'subject_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="batches">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('batch_id',$batches, isset($online_exam_link->batch_id) ? $online_exam_link->batch_id : '' ,['class'=>'form-control','required'=>'required','id'=>'batch_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
