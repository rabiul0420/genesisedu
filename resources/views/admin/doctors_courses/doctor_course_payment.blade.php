        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Doctor Course Payment
                    </div>
                </div>
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>'Admin\DoctorsCoursesController@doctor_course_payment','method'=>'post','files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="panel panel-primary"  style="border-color: #eee; ">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-1 control-label">Payable Amount (<i class="fa fa-asterisk ipd-star" style="font-size:9px;"></i>)  </label>
                                    <div class="col-md-3">
                                        <input type="number" name="amount" class="form-control" required  value="{{ $payable_amount }}" readonly>
                                    </div>
