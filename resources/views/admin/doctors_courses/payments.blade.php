        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>'Admin\DoctorsCoursesController@doctor_course_payments_save','method'=>'post','class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        @endif
                        <div class="panel panel-primary"  style="border-color: #eee; ">
                            <div class="panel-heading" style="background-color: #eee; color: black; border-color: #eee; "> Pay Now</div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <!-- <input type="number" name="amount" class="form-control" required value="{{ ( $doctor_course->readonly() !== null ) ? $doctor_course->course_price - $doctor_course->paid_amount() : '0' }}" {{ $doctor_course->readonly() }} min="0" max="{{ $doctor_course->course_price - $doctor_course->paid_amount() }}"><br> -->
                                        <input type="number" name="amount" class="form-control" required value="0" min="0" max="{{ $doctor_course->course_price - $doctor_course->paid_amount() }}"><br>                                       
                                    </div>
                    ...
                    <div class="form-actions">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <button onclick="return confirm('Are you sure - payment amount of = '+document.getElementsByName('amount')[0].value + ' BDT')" class='btn btn-md btn-primary' type="submit">Submit Payment</button>
                ...
                <div class="panel panel-primary"  style="border:10px;border-color: #eee; ">
                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            <table class="table table-striped table-bordered table-hover userstable datatable dataTable no-footer">
                                <tr>
                                    <th>Serial No</th><th>Date</th><th>Transaction ID</th><th>Note</th><th>Amount</th><th>CURRENCY</th>
                                </tr>
