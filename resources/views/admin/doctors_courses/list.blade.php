        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i>Doctors Courses List
                        ...
                        @endcan--}}
                            ...
                            <a 
                                href="{{ url('admin/doctors') }}?verified=yes&ref=course"
                                class="btn btn-info btn-xs"
                            ...
                            <a 
                                href="{{ url('admin/doctors') }}?verified=no&ref=course"
                                class="btn btn-info btn-xs"
                                style="margin-left: 12px;"
                            > 
                                Unverified Doctors
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/doctors-courses-list",
                    type: 'GET',
                    data: function (d) {
                        d.year = $('#year').val();
