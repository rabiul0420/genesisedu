      ...
      <div class="panel panel-primary"  style="border-color: #eee; ">
       ...
       <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <div class="col-md-3">
           <input type="text" name="refer_by" value="{{ $doctor->doctor_course }}" class="form-control">
          </div>
         </div>
        ...
        <div class="panel panel-primary"  style="border-color: #eee; ">
            <div class="panel-heading" style="background-color: #eee; color: black; border-color: #eee; ">Batch Sifted Information</div>
                <div class="panel-body">
                    ...
                    <div id="batch_shifted_info_div" style="display:block;">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Payment Adjustment</label>
                            <div class="col-md-6">
                                <div class="form-control">
                                    {{ $doctor_course->batch_shift_history->payment_adjustment ?? 0 }} TK
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div id="batch_shifted_info_div" style="display:none;">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <select type="text" name="to_doctor_course_id"  class="form-control" id="to_doctor_course">
                                    ...
                                    <option value="0">Future Batch</option>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Payment Adjustment (*)</label>
                            <div class="col-md-3">
                                <input type="number" name="payment_adjustment" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
       ...
       <div class="panel-body">
        ...
        <div class="years">
         <div class="form-group">
          ...
          <div class="col-md-3">
           <div class="input-icon right">
            {!! Form::select('year',$years, isset($doctor_course->year) ? $doctor_course->year : '' ,['class'=>'form-control','id'=>'year', 'readonly' => 'readonly', 'disabled' => 'disabled']) !!}<i></i>
           </div>
          </div>
         </div>
        </div>
