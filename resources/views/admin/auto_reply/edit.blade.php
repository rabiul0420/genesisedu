        ...
        <div class="col-md-12">
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Auto Reply Link Edit
                    </div>
                </div>

                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                        {!! Form::open(['action'=>['Admin\AutoReplyController@update',$questionlink->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Auto Reply Link
                                (<i class="fa fa-asterisk ipd-star"style="font-size:9px;"></i>) </label>
                                <div class="col-md-6">
                                <div class="input-icon right">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-1 col-md-9">
                                    ...
                                    <a href="{{ url('admin/auto-reply-link') }}" class="btn btn-default">Cancel</a>
                                </div>
                            </div>
                        </div>
                       {!! Form::close() !!}
