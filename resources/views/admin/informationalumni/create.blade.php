    ...
    <div class="col-md-12">
        ...
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i> Alumni Create
                </div>
            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                {!!
                Form::open(['action'=>'Admin\InformationalumniController@store','files'=>true,'class'=>'form-horizontal'])
                !!}
                <div class="form-body">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Result(<i class="fa fa-asterisk ipd-star"
                                    style="font-size:11px;"></i>) </label>

                            <div class="col-md-3" id="Result">
                                <label class="radio-inline">
                                    <input type="radio" name="result" value="Pass"
                                        {{  old('result') === "Pass" ? "checked" : '' }}checked> Pass
                                </label>

                                <label class="radio-inline">
                                    <input type="radio" name="result" value="Failed"
                                        {{  old('result') === "Failed" ? "checked" : '' }}> Failed
                                </label>
                            </div>
                        </div>
