        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Edit User Complain Assign
                    </div>
                </div>
                
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\UserComplainAssignController@update',$user_complain_assign->id],'files'=>true,'method' =>'PUT', 'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">                                
                                <div class="controls">
                                    <input type="text" value="{{ $user_complain_assign->user->name ?? '' }}" readonly class="form-control">
                                    <input type="hidden" value="{{ $user_complain_assign->user->id }}" class="form-control" name="user_id">
                                 </div>                           
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">                                
                                <div class="controls">
                                    <select name="course_complain_type_ids[]" id="" class="form-control course" multiple>
                                        ...
                                        @foreach ($course_complain_types_all as  $course_complain)
                                            <option value="{{ $course_complain->id }}" {{ in_array($course_complain->id,$course_complain_types) ? 'selected' : ' ' }}  >{{ 'Course Name : '. $course_complain->course->name . ' - ' . 'Complain Type : ' .$course_complain->complain_type->name }}</option>
                                        @endforeach
                                    </select>
                                 </div>                           
                            </div>
