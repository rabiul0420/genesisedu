                    ...
                    <div class="container px-sm-2">
                        <div class="big-demo" data-js="hero-demo">
                            ...
                            <div class="tab_view">
                                ...
                                <div id="__all_course" class="tabcontent" style="display: block;">
                                    <div class="row">
                                        <div class="col-12">
                                                                ...
                                                                <tr class="residency">
                                                                    ...
                                                                    <td>
                                                                        <div class="col text-center">
                                                                                <a class="btn btn-success rounded-lg btn-batch" style="margin-bottom:3px"
                                                                                    href="{{ url('batch-details/' . $batch->id) }}">Details
                                                                                </a>
                                                                                <a class="btn btn-warning rounded-lg btn-batch {{ $batch->batch->id ?? 0 ? '' : 'disabled' }}"
                                                                                    href="{{ url('view-batch-schedule/' . ($batch->batch_id ?? 0)) }}">View
                                                                                    Schedule
                                                                                </a>
                                                                        </div>
                                                                    </td>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($batches as $batch )
                                                                    <tr class="residency">
                                                                        ...
                                                                        <td>
                                                                            <p> <a href="{{ url('batch-details/' . $batch->id) }}">{{ $batch->batch_name }}</a>
                                ...
                                <div class="col text-center p-2">
                                    {{-- <a href="http://127.0.0.1:8000/batch" class="btn btn-success rounded-lg">Read More Batch</a> --}}
