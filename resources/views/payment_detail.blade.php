        ...
        <div class="row">
            ...
            <div class="col-md-9 col-md-offset-0">
                ...
                <div class="row col-md-12">
                    ...
                    {!! Form::open(['url' => 'payment-manual/'.$doctor_course->id, 'method' => 'post', 'files' => true, 'class' => 'form-horizontal']) !!}
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="amount" class="form-control" required value="{{ ( $doctor_course->readonly() !== null ) ? $doctor_course->course_price - $doctor_course->paid_amount() : '0' }}" {{ $doctor_course->readonly() }} {{ $doctor_course->payment_option == "default" ? 'readonly' : ''}} min="0" max="{{ $doctor_course->course_price - $doctor_course->paid_amount() }}"><br>                                       
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div> Payment History : <br>
                            <table class="table table-striped table-bordered table-hover userstable datatable dataTable no-footer">
                                <tr>
                                    <th>Serial No</th><th>Date</th><th>Amount</th><th>CURRENCY</th>
                                </tr>
                                @foreach($doctor_course->payments() as $k=>$payment)
                                <tr>
                                    <td>{{ ++$k }}</td><td>{{ Date("jS F - Y, g:i a",$payment->created_at->timestamp) }}</td><td>{{ $payment->amount }}</td><td>BDT</td>
                                </tr>
                                @endforeach                              
                            </table>
                        </div>                        
