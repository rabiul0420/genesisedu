                ...
                <div class="panel panel-default pt-2">
                    <div class="panel_box w-100 bg-white rounded shadow-sm">
                        <div class="header text-center py-3">
                            <h2 class="h2 brand_color">{{ 'My Orders' }}</h2>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <?php if (isset($_GET['msgs'])) {
                            echo "<div class='alert alert-success'>{$_GET['msgs']}</div>";
                        } ?>
                        <?php if (isset($_GET['msgf'])) {
                            echo "<div class='alert alert-success' style='color:red;'>{$_GET['msgf']}</div>";
                        } ?>
                        <?php if (isset($_GET['msgc'])) {
                            echo "<div class='alert alert-success' style='color:red;'>{$_GET['msgc']}</div>";
                        } ?>
                            ...
                            <div class="col-md-12 py-3 px-0">
                                ...
                                <table class="card card-body table table-borderless shadow-sm rounded-lg py-2 my-0">
                                    <tr style="border-bottom: 2px solid #00000040;">
                                        <th colspan="3" style="width: 100%;">
                                            <p>
                                                Sheet of
                                                <span
                                                    class="text-danger">{{ $doctor_course->batch->name ?? '' }}</span>
                                            </p>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <svg style="width: 50px;" data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" title="Admitted with LECTURE SHEETS"
                                                    class="{{ $step1_class }}" xmlns="http://www.w3.org/200 0/svg"
                                                ...
                                                <svg style="width: 50px;" data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" title="Office Processing Completed"
                                                    class="{{ $step2_class }}" xmlns="http://www.w3.org/2000/svg"
                                                    class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                                    stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                ...
                                                <hr class="w-25 border border-dark">
                                                <svg style="width: 50px;" data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" title="Courier Processing Ongoing"
                                                    class="{{ $step3_class }}" xmlns="http://www.w3.org/2000/svg"
                                                    class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                                    stroke="currentColor">
                                                    <path
                                                ...
                                                <hr class="w-25 border border-dark">
                                                <svg style="width: 50px;" data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" title="Received From Courier Services"
                                                    class="{{ $step4_class }}" xmlns="http://www.w3.org/2000/svg"
                                                    class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                                    stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td style="width: 100%;">{{ $doctor_course->created_at->format('d M Y  g:i A') }}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td style="width: 100%;">{{ $doctor_course->payment_status ?? '' }}</td>
                                    </tr>
                                    <tr>
                                        <td style="min-width:140px;">Shipment (1st)</td>
                                        <td>:</td>
                                        <td style="width: 100%;">
                                            {{ $first_shipment->lecture_sheet_delivery_status ?? '' }}</td>
                                    </tr>
                                    <tr>
                                        @if (isset($first_shipment->lecture_sheet_delivery_status) ? $first_shipment->lecture_sheet_delivery_status == 'In_Courier' || $first_shipment->lecture_sheet_delivery_status == 'Completed' ?? '' : '')
                                            <td>Feedback</td>
                                            <td>:</td>
                                            @if ($first_shipment->lecture_sheet_delivery_status == 'Completed')
                                                <td style="font-size: 14px;">লেকচার সীট সংগ্রহ করেছি</td>
                                            @else
                                                <form action="{{ route('lecture_sheet_delivery.feedback') }}"
                                                    method="POST">
                                                    {{ csrf_field() }}
                                                    <td>
                                                        <input type="hidden" name="lecture_sheet_delivery_status_id"
                                                            value="{{ $first_shipment->id }}">
                                                        <select name="feedback" class="form-select"
                                                            style="max-width: max-content; font-size: 14px;">
                                ...
                                @if ($doctor_course->batch->shipment == 2)
                                    <table class="card card-body table table-borderless shadow-sm rounded-lg py-2 my-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td style="width: 100%;">
                                                {{ $doctor_course->created_at->format('d M Y  g:i A') }}</td>
                                        </tr>
                                        <tr>
                                            <td style="min-width:140px;">Courier</td>
                                            <td>:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td style="width: 100%;">
                                                {{ $second_shipment->lecture_sheet_delivery_status ?? ' ' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            @if (isset($second_shipment->lecture_sheet_delivery_status) ? $second_shipment->lecture_sheet_delivery_status == 'In_Courier' || $second_shipment->lecture_sheet_delivery_status == 'Completed' ?? '' : '')
                                                <td>Feedback</td>
                                                <td>:</td>
                                                ...
                                                @else
                                                    <form action="{{ route('lecture_sheet_delivery.feedback') }}"
                                                        ...
                                                        <td>
                                                            <input type="hidden" name="lecture_sheet_delivery_status_id"
                                                                value="{{ $second_shipment->id }}">
                                                            <select name="feedback" class="form-select"
                                                                style="max-width: max-content; font-size: 14px;">
                                                                <option value="" selected>-- Select Your Feedback --
                                                                </option>
                                                                <option value="লেকচার সীট সংগ্রহ করেছি"
