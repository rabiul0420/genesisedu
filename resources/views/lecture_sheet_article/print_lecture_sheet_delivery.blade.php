...
<table>
    ...
    <table cellpadding="3" cellspacing="0"  border="0" style="text-align:justify;border-collapse: collapse; font-size: 15px;display: inline;">
        ...
        <tr> <td>Name</td><td>:</td><td>GENESIS PUBLICATION</td></tr>
        ...
        <tr> <td>Address</td><td>:</td><td>Bayanno Book Shop Ltd.<br>
                First Floor of Eastern Bank Limited ATM Booth<br>
...
@if(isset($lecture_sheets))
    <table style="display: inline-block;">
        ...
        <table  width="450px;"  align="center" cellpadding="3" cellspacing="0"  border="1" style=" font-size: 15px;">
            <thead>
            ...
            @foreach($lecture_sheets as $lecture_sheet)
                ...
                <tr>
                    ...
                    <td align="center"><i class=" fa {{ $lecture_sheet->doctor_delivered ? 'fa-check' : '' }}"></i></td>
