                                    ...
                                    <div class="offset-md-1 py-1">
                                        <div class="institutes my-1">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-4 control-label mb-2"><a href="{{ url('complain-related') }}" class="btn btn-warning">Create Issue</a></label>
                                                <div class="col-md-4">
                                                    <div class="input-icon right">

                                                          <div class="form-check">
                                                            <input class="form-check-input d-none" >
                                                            <label class="form-check-label" style="margin-left: -27px; font-weight:bold; ">
                                                                Complain was related to (please select one) :
                                                            </label>
                                                          </div>

                                                            @foreach ($complain_relateds as $complain_related)
                                                                <div class="form-check">
                                                                    <input class="form-check-input" style="font-size: 13px;" type="radio" name="complain_related_id" id="flexRadioDefault2"  value="{{ $complain_related->id }}">
