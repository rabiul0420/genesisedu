        ...
        <div class="col-md-9 col-md-offset-0">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color:#7fc9f6; color: #FFFFFF;">
                    <h3>Coursewise Online Lecture Links</h3>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12 col-md-offset-0" style="">
                        <hr>
                        <h4><b>Coursewise Online Lecture Links</b></h4>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="btn btn-sm btn-primary" data-toggle='modal'
                                                    data-target='#myModal_{{$link->id}}'>{{ $link->name }}</span>
                                                <div class='modal fade' id='myModal_{{$link->id}}' tabindex='-1'
                                                            ...
                                                            <div class='modal-body'>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <iframe width='100%' height='500'
                                                                        src="pdf/{{$link->pdf_file}}"></iframe>
                                                                </div>
                                                                <!--
                {!! Form::open(['url'=>['send-otp'],'method'=>'post','files'=>true,'class'=>'form-horizontal']) !!}
                    <input type="hidden" name="doctor_id" value="{{$doc_info->id}}">
                    <input type="hidden" name="phone" value="{{$doc_info->mobile_number}}">
                    <input type="hidden" name="video_id" value="{{$link->id}}">
                    <input type="submit" value="Send Request" class="btn btn-xm btn-primary">
                {!! Form::close() !!} 
                -->
                                                            </div>
