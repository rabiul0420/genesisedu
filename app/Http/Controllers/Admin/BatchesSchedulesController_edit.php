...
class BatchesSchedulesController extends Controller
{
    ...
    public function save_batch_schedule_lectures_exams($schedule_id){
        ...
        /*echo '<pre>';
        print_r($_POST['topic_id']);
        print_r($_POST['examtopic']);*/
                ...
                foreach ($topic_id as $key => $value) {
                    ...
                    if($_POST['slot_id'][$key]==2){
                        ...
                        if($_POST['schedule_date'][$key]) {
                            //$exam_topics = implode (", ", $_POST['examtopic_'.$key]);
                            $exam_topics = implode (", ", $_POST['examtopic'][$i++]);
    ...
    public function destroy($id)
    {
        ...
        $batch_schedul = BatchesSchedules::find($id);
        $batch_schedul->deleted_by=Auth::id();
        $batch_schedul->push();
        dd('BatchesSchedules');
