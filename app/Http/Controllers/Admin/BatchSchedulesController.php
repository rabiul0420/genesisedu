...
class BatchSchedulesController extends Controller
{
    ...
    public function mentor_evaluation($id)
    {
        ...
        return view('tailwind.admin.mentor-evaluation.mentor_evaluation', compact('data')); // Tailwind

        // PDF Download
        $pdf = PDF::loadView('tailwind.admin.mentor-evaluation.mentor_evaluation', compact('data'));
    ...
    public function doctors_ratings(Request $request)
    {
        ...
        $lecture_video = LectureVideo::join('doctor_class_views','doctor_class_views.lecture_video_id','lecture_video.id')->whereNotNull('doctor_class_views.ratings')->pluck('name', 'lecture_video.id');
        // return count($lecture_video);
        ...
        // return count( $ratings_details->get());
    ...
    public function master_schedule()
    {
        ...
        $data['rooms'] = \App\Room::pluck('name', 'id');
